...
```text
BACKUPS ORCHESTRATOR: implement goal number 4
```
...
- Active goal: none
- Active branch: `main`
- Current wave: Wave 1 - Foundation and operator console complete
- Completed goals: 01 Intent Preservation And Roadmap, 02 Operator Dashboard Frontend, 03 Dashboard Summary API
- Running goals: none
- Blocked goals: none
- Worker threads: none
...
| 04 | `implementation-goals/GOAL-04-restore-verification.md` | ready | `codex/backups-goal-04-restore-verification` | 03 | Next domain goal |
| 05 | `implementation-goals/GOAL-05-coverage-model.md` | ready | `codex/backups-goal-05-coverage-model` | 03 | May be explored after 04 scope is stable |
...
Implement Goal 04 restore verification evidence:
