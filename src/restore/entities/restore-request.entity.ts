...
export class RestoreRequest {
  ...
  @Column({ type: "varchar", length: 32, default: "production" }) target_environment: string;
  @Column({ type: "varchar", length: 255, nullable: true }) approval_actor: string;
  @Column({ type: "text", nullable: true }) approval_reason: string;
  @Column({ type: "boolean", default: false }) approval_confirmed: boolean;
  @Column({ type: "timestamptz", nullable: true }) approval_recorded_at: Date;
