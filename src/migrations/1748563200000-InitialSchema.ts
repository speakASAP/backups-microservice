  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createTable(new Table({
      ...
      columns: [
        ...
        { name: 'schedule_policy', type: 'varchar', length: '20', default: "'custom_cron'" },
        { name: 'schedule_hour_utc', type: 'int', isNullable: true },
        { name: 'schedule_minute_utc', type: 'int', isNullable: true },
        { name: 'schedule_day_of_week', type: 'int', isNullable: true },
