# Copilot Instructions — `backups-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/backups-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/backups-microservice.git`, branch `main`.
